        ...
        static void CreateRandomMonster(out Monster monster)
{
    ...
    int randNum = rand.Next(1, 4); // Generates a random number between 1 and 3

    switch ((MonsterType)randNum)
    {
        case MonsterType.Slime:
            monster = new Monster { hp = 20, attack = 2 };
            Console.WriteLine("Slime이 생성되었습니다.");
            break;
        case MonsterType.Orc:
            monster = new Monster { hp = 40, attack = 5 };
            Console.WriteLine("Orc가 생성되었습니다.");
            break;
        case MonsterType.Skeleton:
            monster = new Monster { hp = 30, attack = 7 };
            Console.WriteLine("Skeleton이 생성되었습니다.");
            break;
        default:
            monster = new Monster { hp = 0, attack = 0 };
            break;
    }
}
       ...
       static void Fight(ref Player player, ref Monster monster)
{
    while (true)
    {
        ...
        Console.WriteLine($"당신은 몬스터를 공격했습니다! Monster's HP: {monster.hp}");
        ...
        Console.WriteLine($"몬스터가 당신을 공격했습니다! Your HP: {player.hp}");
